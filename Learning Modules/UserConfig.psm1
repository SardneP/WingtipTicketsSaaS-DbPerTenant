...
$ResourceGroupName = "rg-pe-ne-provis-mt-app" # the resource group used when the Wingtip SaaS application was deployed. CASE SENSITIVE
$User              = "developer"         # the User value entered when the Wingtip SaaS application was deployed
